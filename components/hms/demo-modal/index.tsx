...
const data = [
  ...
  },
  {
    ...
    role: 'viewer',
    desc:
      'Sản phẩm này là một công cụ giúp bạn tìm thấy được những nghề nghiệp cụ thể phù hợp với bạn, từ đó bạn có thể tìm hiểu thêm về những nghề nghiệp đó và dấn thân vào nghề nghiệp tương lai của mình.'
  },
  {
    name: 'Q&A',
    roleName: 'q&a',
    ...
    role: 'viewer',
    desc: `Đây là diễn đàn hỏi đáp về định hướng nghề nghiệp công nghệ cho tất cả mọi người, mọi thứ cần biết và chuẩn bị cho một công việc trong lĩnh vực công nghệ đều có thể hỏi đáp ở đây.`
  }
];
